...
begin
  ...
  values (new.id, new.raw_user_meta_data->>'email', new.raw_user_meta_data->>'name', new.raw_user_meta_data->>'avatar_url');
  return new;
end $$;
...
--
-- Name: reactions; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE public.reactions OWNER TO supabase_admin;
...
--
-- Name: reactions reactions_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.reactions
    ADD CONSTRAINT reactions_pkey PRIMARY KEY ("user", comment);
...
ALTER TABLE ONLY public.comments
    ADD CONSTRAINT comments_user_fkey FOREIGN KEY ("user") REFERENCES public.profiles(id);
...
--
-- Name: reactions reactions_comment_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.reactions
    ADD CONSTRAINT reactions_comment_fkey FOREIGN KEY (comment) REFERENCES public.comments(id);


--
-- Name: reactions reactions_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.reactions
    ADD CONSTRAINT reactions_user_fkey FOREIGN KEY ("user") REFERENCES public.profiles(id);
...
--
-- Name: TABLE reactions; Type: ACL; Schema: public; Owner: supabase_admin
--
